$(function() {
  ...
  if ($("#chart-graph").length) {
    var graphChart = new Chart(
      document.getElementById("chart-graph").getContext("2d"),
      {
        type: "line",
        data: {
          labels: [
  ...
  if ($("#chart-polar-area").length) {
    var polarAreaChart = new Chart(
      document.getElementById("chart-polar-area").getContext("2d"),
      {
        type: "polarArea",
        data: {
          datasets: [
