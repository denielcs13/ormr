...
<html class="no-js" lang="">
    <head>
        ...
        <title>Ride a Car | Super Admin</title>
                               ...
                               <div id="error-login"></div>
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="exampleInputEmail1" name="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter user name">
                                    ...
                                    <input type="button" class="btn btn-primary submit-btn btn-block" id="rideacar-login" value="Login">
                                </form>
<!--                                <div class="need-account">
	...
	<!-- JS here -->
        ...
        <script src="js/carjs/login.js"></script>
    </body>
</html>
